  ...
  endpoints: (builder) => ({
    ...
    addReaction: builder.mutation({
      query: ({ postId, reactions }) => ({
        url: `posts/${postId}`,
        method: "PATCH",
        // In a real app we'd probably need to base this on the userId somehow
      ...
      async onQueryStarted(
        ...
        //`updateQueryData` requiresthe endpoint name and cache key arguments
        //so it know whsich piece of cache state to update
